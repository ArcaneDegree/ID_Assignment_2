function LoadFastDocAPI()
{
    ...
    function SendRequestToServerDB(selected_command_execution_mode, new_command_obj_arr, response_received_callback_function)
    {
        ...
        request.session_token = sessionStorage.getItem("session_token");
    ...
    function GetAllMembers(response_received_callback_function)
    {
        GetAllMembers(null, response_received_callback_function);
    }
